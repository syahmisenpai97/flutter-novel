...
class QLoadingSpinWave extends StatefulWidget {
  ...
  @override
  State<QLoadingSpinWave> createState() => _QLoadingSpinWaveState();
}

class _QLoadingSpinWaveState extends State<QLoadingSpinWave> with SingleTickerProviderStateMixin {
